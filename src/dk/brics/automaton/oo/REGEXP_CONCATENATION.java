 ...
 * 
 * modified by Yu Lilin on 2020.3.14
 */
public class REGEXP_CONCATENATION extends oobinregex {
	...
	public static List<ooregex> splitConcatenation(ooregex r) {
		if (r instanceof REGEXP_CONCATENATION) { //a mistake here. the original one is (r instanceof REGEXP_UNION)
...
//			} else {
		...
		if (r2 instanceof REGEXP_CONCATENATION) {
			...
			if (res2 != null) {
				...
				return new REGEXP_CONCATENATION(res2, ((REGEXP_CONCATENATION) r2).exp2); //change r2 to res2
			}
		}
